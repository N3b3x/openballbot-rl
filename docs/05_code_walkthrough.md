...
**Key Files:**
- `ballbotgym/ballbotgym/bbot_env.py` - Main environment (1200+ lines)
- `ballbotgym/ballbotgym/Rewards.py` - Reward functions
- `ballbotgym/ballbotgym/terrain.py` - Terrain generation
- `policies/policies.py` - Neural network architectures
- `scripts/train.py` - Training pipeline
- `scripts/test.py` - Evaluation script
- `utils/utils.py` - Environment factory
- `config/train_ppo_directional.yaml` - Hyperparameters
...
### Evaluation Entry Point: `scripts/test.py`
...
**File:** `ballbotgym/ballbotgym/bbot_env.py` (1215 lines)
...
**File:** `ballbotgym/ballbotgym/Rewards.py` (54 lines)
...
**File:** `ballbotgym/ballbotgym/terrain.py` (92 lines)
...
**File:** `policies/policies.py` (198 lines)
...
**File:** `scripts/train.py` (277 lines)
...
**File:** `config/train_ppo_directional.yaml`
...
**File:** `scripts/gather_data.py` (66 lines)
...
**File:** `scripts/pretrain_cnn.py` (280 lines)
...
train.py
  ...
  │           └── assets/bbot.xml
  └── policies.py
        └── encoder_frozen/encoder_epoch_53
```
