...
**Context:** The repository includes a PID baseline (`ballbot_gym.controllers.PID`) for comparison with RL. Located in `ballbot_gym/controllers/pid.py` as it's classical control, not RL-specific.
